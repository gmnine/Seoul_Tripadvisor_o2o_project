...
file_url_list = open("/Users/gmnine/Pycharm_Projects/pythonProject/step00_data_travel_link_list.txt", "r", encoding="utf-8")
file_store_csv = open("/Users/gmnine/Pycharm_Projects/pythonProject/travel_store2.csv","a",encoding="utf-8")
file_review_csv = open("/Users/gmnine/Pycharm_Projects/pythonProject/travel_review2.csv","a",encoding="utf-8")
...
file_url_list = open(working_folder_path + "step00_data_travel_link_list.txt","r",encoding="utf-8")
file_store_csv = open(working_folder_path + "step01_data_travel_store.csv","a",encoding="utf-8")
file_review_csv = open(working_folder_path + "step01_data_travel_review.csv","a",encoding="utf-8")
...
#     print(kwargs)
#
# 키워드 파라미터 => 모든 key=value 결관값이 그 딕셔너리에 저장
# print_kwargs('review_id' = review_start_id,'store_id' = store_id,'portal_id' = portal_id,'o2o_score' = None,'score' = list_bubble,'processed_review' = None)
